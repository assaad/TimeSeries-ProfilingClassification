...
public class ProgressEx extends JPanel implements ActionListener, PropertyChangeListener {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                JComponent contentPane = new ProgressEx();
    ...
    public void actionPerformed(ActionEvent ou) {
        ...
        if (srcDir.exists() && (srcDir.listFiles() != null && srcDir.listFiles().length > 0)) {
            ...
            progressMonitor = new ProgressMonitor(ProgressEx.this,
